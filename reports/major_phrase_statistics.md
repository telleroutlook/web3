...
_Generated: 2025-10-28 08:25 UTC_
...
The table below keeps the original phrasing from job descriptions, so it captures how employers word their degree requirements.
...
Here the phrases are mapped to a curated list of academic disciplines so that similar descriptions are consolidated.
